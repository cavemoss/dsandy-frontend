        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8" onSubmit={onSubmit}>
            <FieldGroup>
              ...
              <Field>
                <FieldLabel htmlFor={emailModel.id}>Email</FieldLabel>
                <Input {...emailModel} placeholder="m@example.com" required />
              </Field>
              <Field>
                <div className="flex items-center">
                  <FieldLabel htmlFor={passwordModel.id}>Password</FieldLabel>
                  <a href="#" className="ml-auto text-sm underline-offset-2 hover:underline">
                    Forgot your password?
                  </a>
                </div>
                <Input {...passwordModel} required />
              </Field>
              <Field>
